// REQUIRES: dxil-1-10
// RUN: %dxc -HV 202x -I %hlsl_headers -enable-16bit-types -T cs_6_10 %s | FileCheck %s 
...
// using MatrixBTyInt = Matrix<ComponentType::I16, 4, 4, MatrixUse::B, MatrixScope::Wave>;
// using MatrixAccumTy = Matrix<ComponentType::F16, 4, 4, MatrixUse::Accumulator, MatrixScope::Wave>;

// using TSMatrixATy = Matrix<ComponentType::F16, 4, 4, MatrixUse::A, MatrixScope::Thread>;
