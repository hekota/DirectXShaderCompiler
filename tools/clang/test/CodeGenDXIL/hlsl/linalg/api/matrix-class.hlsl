// REQUIRES: dxil-1-10
// RUN: %dxc -HV 202x -I %hlsl_headers -T cs_6_10 %s | FileCheck %s
...
// CHECK-SAME: float addrspace(3)* getelementptr inbounds ([256 x float], [256 x float] addrspace(3)* @"\01?SharedArr@@3PAMA", i32 0, i32 0), i32 0, i32 16, i32 1)  ; LinAlgMatrixLoadFromMemory(memory,offset,stride,layout)
